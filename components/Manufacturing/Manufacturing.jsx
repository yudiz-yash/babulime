...
const MFG_STEPS = [
    ...
    { icon: <Settings size={28} />, title: 'Ultra-Fine Grinding', desc: 'Advanced ultra-fine grinding technology ensures uniform granulation and smooth texture throughout.' },
        ...
        <section id="quality" className="py-12 md:py-24 bg-white">
            <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
                ...
                <AnimateIn animation="fade-up" delay={0} className="text-center mb-8 md:mb-16">
                    ...
                    <h2 className="text-3xl md:text-5xl font-extrabold text-gray-900 mb-4">Manufacturing Excellence</h2>
                    <p className="text-gray-600 max-w-2xl mx-auto text-lg">Engineered for consistency and hygiene at every stage. All machinery fabricated using stainless steel for food safety compliance.</p>
                </AnimateIn>
                        ...
                        <div className="grid md:grid-cols-2 gap-6 md:gap-12 items-center">
                            <div>
                                ...
                                <ul className="space-y-3 text-gray-700 font-medium">
                                    {['FSSAI Standards', 'Good Manufacturing Practices (GMP)', 'Internal Quality Assurance Protocols'].map(item => (
