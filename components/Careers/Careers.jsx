            ...
            <div className="max-w-7xl mx-auto px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-start">
                ...
                <div>
                    ...
                    <div className="bg-white p-8 rounded-2xl shadow-sm border border-purple-100">
                        ...
                        <a href="mailto:babulimepvtltd87@gmail.com" className="inline-flex items-center gap-2 bg-purple-600 text-white px-6 py-3 rounded-lg font-semibold hover:bg-purple-700 transition-colors">
                ...
                <div className="bg-white rounded-3xl p-8 border border-gray-100 shadow-xl">
                    ...
                    <div className="space-y-4">
                        {POSITIONS.map(pos => (
                            <div key={pos.id} className="group border border-gray-100 p-6 rounded-2xl hover:border-purple-200 hover:bg-purple-50 transition-colors flex flex-col sm:flex-row sm:items-center justify-between gap-4 cursor-pointer">
                                <div>
                                ...
                                <div className="text-purple-600 opacity-0 group-hover:opacity-100 transition-opacity transform group-hover:translate-x-1">
                                    <ArrowRight size={24} />
                                </div>
                            </div>
                        ))}
